...
Arduino::Arduino(const char* portName)
{
    ...
    if (this->hSerial == INVALID_HANDLE_VALUE)
    {
        ...
        if (GetLastError() == ERROR_FILE_NOT_FOUND) {
            ...
            TRACE(_T("ERROR: Handle was not attached. Reason: %s not available.\n"));
            //printf(, portName);
    ...
    else
    {
        ...
        if (!GetCommState(this->hSerial, &dcbSerialParams))
        {
            ...
            TRACE(_T("failed to get current serial parameters!\n"));
        }
        else
        {
            ...
            {
                TRACE(_T("ALERT: Could not set Serial Port parameters\n"));
            }
            else
            {
